...
import { core,getGithubToken, getNumberInput, logger, OctokitDefaultOptions } from '@broadshield/github-actions-core-typed-inputs';
...
export type OctokitType<T> = T extends typeof Octokit ? typeof Octokit : T extends typeof GitHub ? typeof GitHub : never;
...
// export const octokit= new Octokit(oOptions);
